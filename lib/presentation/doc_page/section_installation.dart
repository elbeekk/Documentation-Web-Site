      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        IconButton(
                          ...
                          onPressed: ()async {
                            await Clipboard.setData(ClipboardData(text: 'android:label="My App"'),).whenComplete(() => fToast?.showToast(
                                child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        IconButton(
                          ...
                          onPressed: ()async {
                            await Clipboard.setData(ClipboardData(text: '<key>CFBundleName</key> <string>My App</string>'),).whenComplete(() => fToast?.showToast(
                                child: Container(
                                    padding: EdgeInsets.symmetric(
                                        horizontal: 20, vertical: 10),
                                    decoration: BoxDecoration(
            ...
            Text(
              'Setup Firebase with Push Notifications',
              style: AppStyle.dmSans(weight: FontWeight.bold, size: mainTextSize),
            ),
            SizedBox(
              height: 15,
            ...
            SelectableText.rich(
              TextSpan(
                text: '• Click register app and download',
                style: TextStyle(fontSize: textSize, height: textHeight),
                children: [
                  TextSpan(
